...
public  class AdapterTour2 extends FirebaseRecyclerAdapter<ThongTinTour,AdapterTour2.MyViewHolder>{
     ...
     * @param options
     */
    public AdapterTour2(@NonNull FirebaseRecyclerOptions<ThongTinTour> options) {
        super(options);
    }
